 ...
 * Generated: 2026-08-04T19:38:18.284Z
 */

/**
 * ludavia theme — built by `npx astryx theme build`
 * Import the CSS file alongside this module:
 *
 *   import { ludaviaTheme } from './ludavia';
 *   import './ludavia.css';
 */
export const ludaviaTheme = {
  name: 'ludavia',
  __built: true,
  tokens: {
    ...
    "--color-background-surface": "light-dark(#ffffff, #141217)",
    "--color-background-body": "light-dark(#f5f3f7, #0b0a0d)",
    "--color-background-card": "light-dark(#ffffff, #1b171f)",
    "--color-background-popover": "light-dark(#ffffff, #211b27)",
    "--color-background-muted": "light-dark(#f0edf2, #18131b)",
    "--color-accent": "light-dark(#4e1d8e, #4e1d8e)",
    "--color-accent-muted": "light-dark(#4e1d8e1a, #4e1d8e33)",
    "--color-neutral": "light-dark(#1D1B1F1A, #E4E1E733)",
    "--color-overlay": "light-dark(#130d1a66, #050406cc)",
    "--color-overlay-hover": "light-dark(#2e25330d, #ffffff0d)",
    "--color-overlay-pressed": "light-dark(#2e25331a, #ffffff1a)",
    "--color-text-primary": "light-dark(#1d1821, #f6f0f7)",
    "--color-text-secondary": "light-dark(#6d6572, #b9adb9)",
    "--color-text-disabled": "light-dark(#aaa1ad, #716875)",
    ...
    "--color-icon-primary": "light-dark(#1d1821, #f6f0f7)",
    "--color-icon-secondary": "light-dark(#6d6572, #b9adb9)",
    "--color-icon-disabled": "light-dark(#aaa1ad, #716875)",
    ...
    "--color-border": "light-dark(#2e25331a, #f6f0f71f)",
    "--color-border-emphasized": "light-dark(#c9becd, #5a4d60)",
    "--color-skeleton": "light-dark(#c9becd, #5a4d60)",
    "--color-shadow": "light-dark(#0000001a, #00000066)",
    ...
    "--color-background-inverted": "light-dark(#1D1B1F, #FEFBFF)",
    "--color-track": "light-dark(#c9becd, #5a4d60)"
  },
